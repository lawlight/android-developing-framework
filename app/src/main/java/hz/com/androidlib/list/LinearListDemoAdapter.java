 ...
 */
public class LinearListDemoAdapter extends RecyclerView.Adapter<LinearListDemoAdapter.ViewHolder> {

    List<ListDemoBean> list;


    public LinearListDemoAdapter(List<ListDemoBean> list) {
        this.list = list;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_linear_demo, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.tvText2.setText(item.text2);
