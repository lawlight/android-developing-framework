...
public class ScanActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mErrorMask = (ImageView) findViewById(R.id.capture_error_mask);
        mScanMask = (ImageView) findViewById(R.id.capture_scan_mask);
        mScanArea = (FrameLayout) findViewById(R.id.capture_crop_view);
        mLightBtn = (Button) findViewById(R.id.capture_light_btn);
        mContainer = (RelativeLayout) findViewById(R.id.capture_container);
        mSwitchModeBtn = (Button) findViewById(R.id.switch_mode_btn);
